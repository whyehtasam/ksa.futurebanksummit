          ...
          <div className="my-16">
            {imageData.map((item, index) => (
              <>
                ...
                {item.path.map((item) =>  <div className="image flex-1 shadow-md my-8 rounded-md hover:scale-[1.01] hover:drop-shadow-sm hover:-translate-y-2 transition-all duration-200 cursor-pointer" key={index}>
